...
public class ABC {
    ...
    public static void keyEncrypt(String prefix){
        ...
        String profixUUID = prefix + "-" + uuid + "-8080" + "-" + UUID.randomUUID().toString().substring(0,5);
        uuid = profixUUID;
...
//        System.out.println( "This is Encrypt Code = " + code + " Hash = " + hash);
        ...
        String dec = keyDecrypt(hash);

        if (!profixUUID.equals(dec)){

        }

        System.out.println( hash + "  "  + profixUUID + " " + dec);
    }

    public static String keyDecrypt(String hashCode) {
        String decrypted = "";
        try {
